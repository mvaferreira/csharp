...
namespace IPSniffer
{
    public class IP
    {
        ...
        public IP(byte[] byBuffer, int nReceived)
        {
            ...
            {
                Console.WriteLine("IPHeader: " + ex.Message);
        ...
        public Protocol ProtocolType
        {
            get
            {
                //Console.WriteLine("Protocol type ----> " + byProtocol);
                ...
                else if (byProtocol == 1)  //One for ICMP
                {
                    return Protocol.ICMP;
                }
                else if (byProtocol == 2)  //Two for ICMP
                {
